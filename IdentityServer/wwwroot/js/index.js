		...
		layer.open({
			...
			success : function(index, layero){
				...
				$(".skins_box .layui-form-radio").on("click",function(){
					var skinColor;
					var aaa = "   藏青".trim();
					if ($(this).text().trim().includes("藏青")) {
						skinColor = "cyan";
					} else if ($(this).text().trim().includes("蓝色")) {
						skinColor = "blue";
					} else if ($(this).text().trim().includes("默认")){
						skinColor = "";
					}
					if (!$(this).text().trim().includes("自定义")){
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
						    ...
						    '<div class="admin-header-lock-name" id="lockUserName">' + _username + '</div>'+
							'<div class="input_btn">'+
