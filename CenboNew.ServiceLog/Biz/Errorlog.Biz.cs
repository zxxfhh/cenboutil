...
namespace CenboNew.ServiceLog
{
    public partial class ErrorLog : Entity<ErrorLog>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化Errorlog[错误日志]数据……");
        ...
        //    entity.dataType = "abc";
        //    entity.logMessage = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化Errorlog[错误日志]数据！");
        //}
        ...
        public static ErrorLog FindBysnowId(Int64 snowId)
        {
        ...
        // Select Count(Id) as Id,Category From errorlog Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<Errorlog> _CategoryCache = new FieldCache<Errorlog>(nameof(Category))
        //{
